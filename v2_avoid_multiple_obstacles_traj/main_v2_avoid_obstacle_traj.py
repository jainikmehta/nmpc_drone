...
if random_obstacles == False:
    initial_obstacle_centers = np.array([[0.85, 0.75], [0.3,0.3], [0.5, 0.8], [0.75, 0.25], [0.25, 0.75]])  # Fixed obstacle centers
...
nmpc_node_robot = nmpc_node(num_states=num_states, num_controls=num_controls, 
                              ...
                              num_obstacles=num_obstacles, obstacle_centers=initial_obstacle_centers, 
...
while goal_reached == False:
    ref_waypoints = ref_generator.generate_waypoints(
        ...
        obstacle_centers=initial_obstacle_centers)
